...
public class AkkaFeignClientFactoryBean implements FactoryBean<Object>, InitializingBean, ApplicationContextAware {
...
//                new Target.HardCodedTarget<>(this.type, this.name, url));
    ...
    public boolean equals(Object o) {
        ...
        AkkaFeignClientFactoryBean that = (AkkaFeignClientFactoryBean) o;
